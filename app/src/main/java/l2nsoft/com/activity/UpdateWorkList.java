...
public class UpdateWorkList extends AppCompatActivity {
        ...
        btnSub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(arName)) {
                    ...
                    FirebaseDatabase.getInstance().getReference().child("testing ").push().setValue(map)
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void unused) {
                                    ...
                                    etAreaName.setText("");
                                    AlertDialog.Builder builder = new AlertDialog.Builder(UpdateWorkList.this);
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    ...
                                    Toast.makeText(UpdateWorkList.this, e.getMessage(), Toast.LENGTH_SHORT).show();
